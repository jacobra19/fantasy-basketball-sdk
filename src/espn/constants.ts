export const FANTASY_BASE_ENDPOINT =
...
export const View = {
  ...
  MTopPerformers: 'mTopPerformers',
  KonaGameState: 'kona_game_state',
  MMatchup: 'mMatchup',
  MStandings: 'mStandings',
  MDraftDetail: 'mDraftDetail',
  KonaPlayerInfo: 'kona_player_info',
  KonaPlayerCard: 'kona_playercard',
  KonaLeagueCommunication: 'kona_league_communication',
  MTransactions2: 'mTransactions2',
...
export const POSITION_MAP: Record<number | string, number | string> = {
  0: 'PG',
  1: 'SG',
  2: 'SF',
  3: 'PF',
...
export const ACTIVITY_MAP: Record<number | string, number | string> = {
  178: 'FA ADDED',
  180: 'WAIVER ADDED',
  179: 'DROPPED',
  181: 'DROPPED',
